                              ...
                              {vars.map((v) => (
                                <button
                                  ...
                                  style={{
                                    ...
                                    background: cat.id === 'core' ? '#DBEAFE' : cat.id === 'special' ? '#FFF1EC' : '#FEF3C7',
                                    color: cat.id === 'core' ? '#1E40AF' : cat.id === 'special' ? '#C2410C' : '#92400E',
                                    border: '1px solid',
                                    borderColor: cat.id === 'core' ? '#93C5FD' : cat.id === 'special' ? '#FECDB8' : '#FDE68A',
